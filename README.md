...
- **Вёрстка:** HTML5, CSS3 (БЭМ-методология с файловой структурой)
...
- **Конфигурация:** Переменные окружения через `.env` (12-factor app)
...
- **Template-рендеринг** — карточки создаются из `<template>`, что снижает нагрузку на DOM
...
Откройте демо-версию по ссылке: [annenkov-konstantin.github.io/mesto-project-ff](https://annenkov-konstantin.github.io/mesto-project-ff/)
